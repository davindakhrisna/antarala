...
const Situs = () => {
  ...
  return info ? (
    <section className="p-12 sm:p-24 bg-[#FAF4E1]">
      <div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-2 md:gap-12 lg:gap-4">

        {/* Text */}
        <div className="space-y-6 md:space-y-7 max-w-md xl:max-w-xl text-center lg:text-start">
        ...
        {/* Image */}
        <div className="relative flex justify-center items-center w-8/10 lg:w-auto lg:justify-end">
          <Image
            src={info.image}
            width={1}
            height={1}
            alt="Image Situs"
            className="w-full md:w-8/10 pb-16 md:pb-18"
          />
          <Image
            src={info.imageMini}
            width={200}
            ...
            className="w-5/10 sm:w-3/10 md:w-4/10 object-fit border-12 border-[#FAF4E1] absolute bottom-0 rounded-full lg:left-0"
          />
        </div>
